    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            My background in software engineering has provided me with the
            skills to solve design problems one step at a time. I am naturally
            curious and confident in my ability to make a positive impact on any
            team.
          </p>
          <p>
            Outside of work, I am a sports fanatic and photography enthusiast. I
            am also tech-obsessed and always eager to explore new technologies
            and gadgets.
          </p>
        </div>
